...
if __name__ == "__main__":
    ...
    resumen("Round Robin (q=1)", round_robin(WORKLOAD, quantum=1))
    resumen("Round Robin (q=5)", round_robin(WORKLOAD, quantum=5))
    resumen("Round Robin (q=100)", round_robin(WORKLOAD, quantum=100))